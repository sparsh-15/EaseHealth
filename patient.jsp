    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
        ...
        <head>
            ...
            <style>
                ...
                /* CSS to fix the alignment of the metric value percentage */
                .health-metric {
                    position: relative;
                    width: 100px;
                    margin: 0 auto;
                    ...
                    <div class="modal-content rounded-4 shadow">
                        ...
                        <form action="complete_patient_profile.do" method="post" enctype="multipart/form-data"
                            ...
                            <div class="mb-2 text-center">
                                ...
                                <input type="file" name="profile_pic" id="profile_pic" name="profile_pic"
                                    accept="image/*" class="form-control w-75 mx-auto" required>
                ...
                <% if (message !=null && !message.isEmpty()) { %>
                    ...
                    <% } %>
                        ...
                        <div class="main-content">
                            ...
                            <div class="row mb-4 requires-profile">
                                ...
                                <div class="col-md-3 col-6 mb-3 mb-md-0">
                                    <div class="card stat-card h-100">
                                        ...
                                        <div class="stat-value" id="prescription-stat">${fn:length(activePrescriptions)}
                                        </div>
                                ...
                                <div class="card mb-3 shadow-sm border-0">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="fw-semi-bold text-dark my-2">
                                            <i class="fas fa-calendar-check me-2 text-primary"></i> Upcoming
                                            Appointments
                                        </h5>
                                        ...
                                        <div class="row card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="dropdown col-2">
                                                <button class="btn btn-outline-primary dropdown-toggle" type="button"
                                                    id="cityFilterButton" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                ...
                                                <ul class="dropdown-menu city-dropdown overflow-auto"
                                                    style="height: 450px;" aria-labelledby="cityFilterButton">
                                            ...
                                            <c:choose>
                                                <c:when test="${not empty activePrescriptions}">
                                                    <c:forEach var="pres" items="${activePrescriptions}">
                                                        <div
                                                            class="prescription-card p-3 mb-3 border rounded shadow-sm">
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-muted mb-1">
                                                                        <i
                                                                            class="fas fa-clinic-medical me-2 text-info"></i>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-outline-primary btn-sm w-100" data-bs-toggle="modal"
                                                data-bs-target="#healthMetricsModal">
                                                Update Metrics
                                            </button>
                            ...
                            <div class="modal fade" id="healthMetricsModal" tabindex="-1"
                                aria-labelledby="healthMetricsModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="healthMetricsModalLabel">Update Health Metrics
                                            </h5>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="systolic"
                                                            placeholder="Systolic" min="80" max="200" value="120">
                                                        <span class="input-group-text">/</span>
                                                        <input type="number" class="form-control" id="diastolic"
                                                            placeholder="Diastolic" min="40" max="120" value="80">
                                                        <span class="input-group-text">mmHg</span>
                                                    </div>
                                                    <div class="form-text">Normal range: 120/80 or lower</div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="weight"
                                                            placeholder="Weight" step="0.1" min="30" max="200"
                                                            value="68">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="heartRate"
                                                            placeholder="Heart Rate" min="40" max="200" value="72">
                                                        <span class="input-group-text">bpm</span>
                                                    </div>
                                                    <div class="form-text">Normal resting range: 60-100 bpm</div>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" id="saveHealthMetrics">Save
                                                Changes</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3 ">
                                                    <div class="card article-card shadow h-100">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text text-muted">Learn about the latest
                                                                research
                                                                on
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <div class="card article-card">
                                                        <img src="https://www.deliciouslycleaneats.com.au/wp-content/uploads/2023/06/Debunking-nutrition-myths.png"
                                                            class="article-img" alt="Article Image">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Nutrition Myths Debunked</h5>
                                                            <p class="card-text text-muted">Our experts separate fact
                                                                from
                                                                fiction about
                                                                the
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <div class="card article-card">
                                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjY8l7jH_mjB9qJh0e5-kACB0N3Pq2DxtEeQ&s" class="article-img"
                                                            alt="Article Image">
                                                        <div class="card-body">
                                ...
                                <div class="col-lg-8" id="find_nearby_clinic">
                                    <div class="card shadow-sm border-0">
                                        <div class="card-header bg-primary text-white">
                                            <h5 class="mb-0"><i class="fas fa-search-location me-2"></i>Find Nearby
                                                Clinics
                                            </h5>
                                        </div>
                                        <div class="card-body">
                                            <!-- City Select -->
                                            <div class="mb-4">
                                                <label for="city" class="form-label fw-semibold">Select Your
                                                    City</label>
                                                <select class="form-select" id="clinic_city_id" name="city_id" required
                                                    ...
                                                    <c:forEach var="ct" items="${cities}">
                                                        <option value="${ct.cityId}" ${ct.city==user.city.city
                                                            ? 'selected' : '' }>
                                                            ${ct.city} (${ct.state.state})
                                                        </option>
                                                    </c:forEach>
                        ...
                        <div id="moodToast" class="toast-container position-fixed bottom-0 end-0 p-3"
                            style="z-index: 9999;">
